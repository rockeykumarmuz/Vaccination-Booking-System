...
//    }
    ...
    public ResponseEntity addDose1(@RequestBody BookDose1RequestDto bookDose1RequestDto) {
        ...
        {
            // int a=2/0;
            Dose dose = doseService.addDose1(bookDose1RequestDto);
            return new ResponseEntity(dose, HttpStatus.CREATED);
        }
        catch(Exception e) {
            return new ResponseEntity(e.getMessage(), HttpStatus.BAD_REQUEST);
...
//    public ResponseEntity addDose2(@RequestParam("id") int pesronId, @RequestParam("doseType")DoseType doseType) {
//
//        try
//        {
//            Dose dose = doseService.addDose2(pesronId, doseType);
//            return new ResponseEntity(dose, HttpStatus.CREATED);
//        }
//        catch(Exception e) {
//            return new ResponseEntity(e.getMessage(), HttpStatus.BAD_REQUEST);
...
//    @PostMapping("/add_dose_2")
//    public ResponseEntity addDose2(@RequestBody BookDose1RequestDto bookDose1RequestDto) {
//
//        try
//        {
//            Dose dose = doseService.addDose2(bookDose1RequestDto);
//            return new ResponseEntity(dose, HttpStatus.CREATED);
//        }
//        catch(Exception e) {
//            return new ResponseEntity(e.getMessage(), HttpStatus.BAD_REQUEST);
